    ...
    return (
        <div
            ...
            style={{
                ...
                position: "absolute",
                width: isMaximized ? "calc(100% - var(--window-offset-left))" : isSnapped !== 'none' ? "50%" : "90%",
                maxWidth: isMaximized || isSnapped !== "none" ? "none" : "600px",
                height: isMaximized ? "calc(100% - var(--dock-bottom, 0px))" : "450px",
                maxHeight: isMaximized ? "none" : "80%",
                backgroundColor: "#222",
                ...
                left: isMaximized ? "var(--window-offset-left)" : "auto",
